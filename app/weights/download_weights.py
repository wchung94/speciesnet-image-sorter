...
def main() -> None:
    ...
    weight_dir = os.environ["KAGGLEHUB_CACHE"] = os.path.join(
    ...
    if not os.path.exists(weight_dir + "models/speciesnet.pt"):
        ...
        speciesnet_path = kagglehub.model_download(
            "google/speciesnet/pyTorch/v4.0.2b",
            path="full_image_88545560_22x8_v12_epoch_00153.pt",
        )
        ...
        print(
            "Speciesnet Model files already exist: "
            + weight_dir
            + "models/speciesnet.pt"
        )
