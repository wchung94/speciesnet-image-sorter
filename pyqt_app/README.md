...
[ARCHIVED]
The app will not be updated anymore for pyqt, but will continue in streamlit support.
...
To run the application in streamlit, you can use `uv run streamlit run app/streamlit_app.py` [WIP]
...
./SimpleImageSorter/
    ...
    pyqt_app/
        ...
        └── file_operations.py
```
![Example Gui](../docs/example_app_pyqt.png)
